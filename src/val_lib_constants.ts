...
export const schedulingInterval: number = 30
export const jobSegmentSpacing: number = 10
...
export const weakensPerHack: number = hackAmount/weakenAmount
export const weakensPerGrow: number = growAmount/weakenAmount
export const hacksPerWeaken: number = weakenAmount/hackAmount
export const growsPerWeaken: number = weakenAmount/growAmount
